...
export async function POST(req) {
  ...
  <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <h2 style="color:#003366; text-align:center;">🧾 New Counselling Payment Received</h2>
    <p>Dear Admin,</p>
    <p>You have received a new counselling payment. Here are the details:</p>
    <table style="border-collapse: collapse; width: 100%; max-width: 500px; margin: 20px auto; font-size: 14px;">
      ...
      <tr>
        <td style="border: 1px solid #ddd; padding: 8px; font-weight: bold;">UTR Number</td>
        <td style="border: 1px solid #ddd; padding: 8px;">${utr}</td>
      </tr>
      <tr>
    ...
    <p style="margin-top:20px;">Please verify the payment and update records accordingly.</p>
